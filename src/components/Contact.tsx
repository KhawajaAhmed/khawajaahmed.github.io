    ...
    <AnimatedSection id="contact" className="py-16 sm:py-20 px-4 sm:px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
          ...
          <AnimatedItem className="space-y-8" delay={0.2} direction="left">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">khawajaahmed_2025@depauw.edu</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">Greencastle, Indiana</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">(702) 348-9820</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-4 sm:mb-6">
              ...
              <div className="flex space-x-4">
                <a href="https://github.com/khawajaahmed" target="_blank" rel="noopener noreferrer" className="bg-gray-200 dark:bg-gray-800 p-3 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900 transition-colors">
          ...
          {/* Contact Links */}
          <AnimatedItem className="glass-effect bg-white/50 dark:bg-gray-800/40 rounded-lg shadow-md p-8" delay={0.4} direction="right">
            <h3 className="text-2xl font-semibold mb-6">Let's Connect</h3>
            
            <div className="space-y-6">
              <div className="glass-effect bg-white/30 dark:bg-gray-700/30 p-4 rounded-lg transition-all hover:scale-105">
                <a href="https://www.linkedin.com/in/khawajahussainahmed/" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-4">
                  <div className="bg-blue-100 dark:bg-blue-900 p-3 rounded-full">
                    <svg className="w-6 h-6 text-blue-600 dark:text-blue-300" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                    </svg>
                  </div>
                  <div>
              ...
              <div className="mt-6 text-center">
                <p className="text-gray-600 dark:text-gray-400 mb-2">Prefer email? You can reach me at:</p>
                <a 
                  href="mailto:khawajaahmed_2025@depauw.edu" 
                  className="font-medium text-blue-600 dark:text-blue-400 hover:underline inline-block transition-all hover:scale-105"
                >
